...
export const PROFILE = {
  ...
  tagline: "I engineer AI-powered systems, RAG pipelines & intelligent data platforms. From healthcare AI agents to enterprise LLM integrations — I turn data into intelligence that ships.",
